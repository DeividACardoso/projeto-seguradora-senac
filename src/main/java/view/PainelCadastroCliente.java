...
public class PainelCadastroCliente extends JPanel {
	...
	public PainelCadastroCliente() {
		...
		add(lblTitulo, "3, 1, 5, 1, center, default");
		...
		add(txtNome, "3, 5, 5, 1, fill, default");
		...
		add(txtCPF, "3, 11, 5, 1, fill, default");
		...
		dpDataNascimento.getComponentToggleCalendarButton().addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			}
		});
		add(dpDataNascimento, "4, 10, 2, 1, fill, fill");
		add(dpDataNascimento, "3, 17, fill, default");
		
		JLabel lblTelefone = new JLabel("Telefone:");
		lblTelefone.setForeground(Color.WHITE);
		lblTelefone.setFont(new Font("Trebuchet MS", Font.PLAIN, 15));
		add(lblTelefone, "6, 17, right, center");
		...
		try {
			...
			txtTelefone.setBounds(94, 53, 106, 20);
		...
		txtCPF = new JFormattedTextField(mascaraTelefone);
		try {
			mascaraTelefone.stringToValue(txtTelefone.getText());
		...
		add(txtTelefone, "7, 17, fill, default");
		...
		add(txtEndereco, "3, 23, 5, 1, fill, default");
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(cliente == null) {
					...
					try {
						...
						cliente.setCpf(mascaraCpf.stringToValue(txtCPF.getText()).toString());
						cliente.setTelefone(mascaraTelefone.stringToValue(txtTelefone.getText()).toString());
					} catch (ParseException e1) {
					}
